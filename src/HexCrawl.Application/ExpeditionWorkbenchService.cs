...
public sealed class ExpeditionWorkbenchService(
    ...
    GeneratedProcedureResolutionVerifier generatedResolutionVerifier)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var automaticResolution = generatedResolutionVerifier.VerifyWorkbench(expedition, state, runtimeProfile, command);
        ...
        {
            Runtime = (ExpeditionState)finalized.Runtime,
