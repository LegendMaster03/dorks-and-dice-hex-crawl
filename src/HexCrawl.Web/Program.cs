...
builder.Services.AddScoped<GeneratedProcedureResolutionVerifier>();
builder.Services.AddSingleton<IProcedureResolutionRandomSource, PseudoRandomProcedureResolutionSource>();
