...
4. Continue decomposing the expedition workbench into focused components now that route ownership is module-driven. Source-map affine registration and Wonderdraft review/import are already isolated behind dedicated controllers.
